...
server.route([{
    ...
    },
    {
        ...
        handler: function(req, reply) {
            var beginIndexVar = req.query.beginIndex || 0
            var maxResultsVar = req.query.maxResults || 10
    ...
    },
    {
        ...
        handler: function(req, reply) {
            loadCollection(req.params.collectionName, function(collection) {
                collection.update({ _id: id(req.params.id) }, { $set: req.payload }, { safe: true, multi: false }, function(e, result) {
                    if (e) return reply(e)
